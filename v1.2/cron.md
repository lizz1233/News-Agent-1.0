...
```
/loop 1440m run the news agent 1.2 pipeline
```
...
- **Durable:** true
- **Prompt:** "Run the news agent 1.2 pipeline: read config from news agent 1.2/News Agent Config.md, check .news-cache.json for cache, WebSearch any uncached topics, filter, rank, and write output to MM-DD-YYYY HH.MM.SS.md."
